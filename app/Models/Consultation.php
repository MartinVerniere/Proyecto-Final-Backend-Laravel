...
class Consultation extends Model
{
	...
	public static function actualizarConsulta($request, $id_consultation) {
        $consultation = Consultation::find($id_consultation);

        $consultation->fecha_realizacion = $request->input('fecha_realizacion');
        $consultation->talla = $request->input('talla');
		$consultation->talla_sentado = $request->input('talla_sentado');
        $consultation->peso = $request->input('peso');
		$consultation->presion_arterial_maxima = $request->input('presion_arterial_maxima');
		$consultation->presion_arterial_minima = $request->input('presion_arterial_minima');
    ...
    public static function quitarConsulta($id) {
