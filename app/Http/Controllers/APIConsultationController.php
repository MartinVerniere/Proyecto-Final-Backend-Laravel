...
class APIConsultationController extends Controller
{
    ...
    private function validateNuevaConsulta(Request $request) {
        $validated = $request->validate([
            ...
            'antecedentes_personales' => 'sometimes|file',
            'antecedentes_familiares' => 'sometimes|file',
            'antecedentes_lesiones' => 'sometimes|file',
            'estudios_laboratorio' => 'sometimes|file',
            'observaciones_estudios_laboratorio' => 'sometimes|string',
            'estudio_cardiologico' => 'sometimes|file',
            'observaciones_estudio_cardiologico' => 'sometimes|string',
            'desayuna' => 'sometimes|in:SI,NO',
            'almuerza' => 'sometimes|in:SI,NO',
            'merienda' => 'sometimes|in:SI,NO',
            'cena' => 'sometimes|in:SI,NO',
            'hidratacion' => 'sometimes|numeric',
            'anotaciones' => 'sometimes|string',
        ]);
        return $validated;
    }
